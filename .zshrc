...
alias susnb="systemctl --user --no-block  start"
alias sur="systemctl --user restart"
alias surnb="systemctl --user --no-block restart"
alias suss="systemctl --user status"
alias susp="systemctl --user stop"
alias suspnb="systemctl --user --no-block  stop"
...
alias slsnb="sudo systemctl --no-block start"
alias slr="sudo systemctl restart"
alias slrnb="sudo systemctl --no-block restart"
alias slss="sudo systemctl status"
alias slsp="sudo systemctl stop"
alias slspnb="sudo systemctl --no-block stop"
